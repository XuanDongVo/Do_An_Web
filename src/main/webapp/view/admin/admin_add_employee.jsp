		...
		<div class="container mt-5">
			...
			<div class="tab-content mt-4" id="productTabContent">
				<div class="tab-pane fade show active" id="spu" role="tabpanel"
					...
					<form action="${pageContext.request.contextPath}/add_employee_action" method="POST">
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="customerName" class="form-label">Email
							</label> <input type="text" class="form-control" id="email_employee"
								name="email_employee" >
						</div>
						<div class="mb-3">
							<label for="orderDetails" class="form-label">Số điện thoại</label> <input
								type="text" class="form-control" id="phone_employee"
								name="phone_employee"   >
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="quantity" class="form-label">Tên nhân viên</label> <input
								type="text" class="form-control" id="name_employee" name="name_employee"
								>
						</div>
						<div class="mb-3">
							<label for="orderStatus" class="form-label">Phân quyền</label> 
							<input
								type="text" class="form-control" id="role"
								name="role" >
						</div>
						<button type="submit" class="btn btn-primary" id="saveSpu">Thêm nhân viên</button>
					</form>
				</div>
