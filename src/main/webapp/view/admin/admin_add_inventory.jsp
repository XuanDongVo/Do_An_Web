		...
		<div class="container mt-5">
			...
			<ul class="nav nav-tabs" id="productTab" role="tablist">
				<li class="nav-item">
					<button class="nav-link active" id="spu-tab" data-bs-toggle="tab"
						data-bs-target="#spu" type="button" role="tab">Thêm sản
						phẩm vào kho</button>
				</li>
			...
			<div class="tab-content mt-4" id="productTabContent">
				<div class="tab-pane fade show active" id="spu" role="tabpanel"
					...
					<form action="${pageContext.request.contextPath}/add_inventory"
						method="POST">
						<div class="mb-3">
							<label for="role" class="form-label">Mã sản phẩm</label> <select
								class="form-control" id="role" name="sku_id" required>
								<option value="" disabled selected>-- Chọn mã sản
									phẩm--</option>
						...
						<button type="submit" class="btn btn-primary" id="saveStock">Thêm
							sản phẩm vào kho</button>
					</form>
				</div>
