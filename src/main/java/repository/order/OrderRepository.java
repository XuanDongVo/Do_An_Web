...
public class OrderRepository {
    ...
    public long createOrder(OrderRequest orderRequest, User user) {
        ...
        try {
            ...
            // Kiểm tra nếu người dùng tồn tại, sử dụng ID người dùng; nếu không, đặt giá trị NULL cho user_id
    ...
    // Phương thức hỗ trợ đóng các tài nguyên (Connection, PreparedStatement, ResultSet)
